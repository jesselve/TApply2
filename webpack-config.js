...
/*  var index = options.indexFile || require('fs').existsSync(path.join(process.cwd(), 'index.html'))
  ...
  var index = options.indexFile || require('fs').existsSync(path.join(options.sourceDirectory || 'src', 'index.html')) ? path.join(options.sourceDirectory || 'src', 'index.html') : path.join(__dirname, 'sample','index.html')
